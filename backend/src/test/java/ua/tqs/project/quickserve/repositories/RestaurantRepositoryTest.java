...
class RestaurantRepositoryTest {
    ...
    void whenFindRestaurantByIdthenReturnRestaurant() {
        Restaurant restaurant = new Restaurant("McDonald's", "Number 1 in the fast food industry!", 123123123, State.OPEN, restaurantAddress1, manager1);
    ...
    void whenFindAllRestaurantsthenReturnRestaurantes() {
        Restaurant restaurant1 = new Restaurant("McDonald's", "Number 1 in the fast food industry!", 12312312, State.OPEN, restaurantAddress1, manager1);
        restaurant1.setTimes("10:00:00", "04:00:00");
        Restaurant restaurant2 = new Restaurant("Burger King", "Number 2 in the fast food industry!", 123123123, State.OPEN, restaurantAddress2, manager2);
